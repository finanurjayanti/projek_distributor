...
<template>
  ...
  <div class="grid grid-cols-12 grid-rows-6 w-screen h-screen">
    <div
      class="row-start-1 row-span-2 col-start-1 col-span-6 rounded-xl m-3 grid grid-cols-6 grid-rows-6"
    >
      <div
    ...
    <div
      class="row-start-1 row-span-2 col-start-7 col-span-6 bg-blue-900 rounded-xl m-3 grid grid-cols-6 grid-rows-6"
    >
      <div
        class="row-start-1 row-span-1 col-start-1 col-span-3 m-1 flex items-center justify-start rounded-md p-2"
      >
        <span class="font-medium text-white"><p>Transaksi Terakhir</p> </span>
      </div>
    </div>
    <div
